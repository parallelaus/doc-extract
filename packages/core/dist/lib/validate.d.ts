 ...
 */
export declare const validateClientOptions: (options: DocExtractClientOptions | undefined, clientOptionsSchema: z.ZodType<DocExtractClientOptions>) => DocExtractClientOptions;
